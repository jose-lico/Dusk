...
namespace DuskEngine
{
	...
	void ContentBrowserPanel::OnImGuiRender()
	{
		...
		int buttons_count = std::distance(std::filesystem::directory_iterator(m_CurrentDirectory), std::filesystem::directory_iterator{});
	...
	void ContentBrowserPanel::CreateResources()
	{
		m_Icons.resize(0);
